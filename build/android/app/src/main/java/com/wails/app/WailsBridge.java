...
public class WailsBridge {
    ...
    public void startForegroundService(final String json) {
        // IceTray keeps the process alive with PlaybackService (mediaPlayback),
        // not the stock Wails dataSync foreground service.
        Log.i(TAG, "Ignoring Wails dataSync foreground service start");
    }

    /** Stop the foreground service. */
    public void stopForegroundService() {
        Log.i(TAG, "Ignoring Wails dataSync foreground service stop");
    }
